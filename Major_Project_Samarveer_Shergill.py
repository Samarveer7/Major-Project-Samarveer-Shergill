...
def event2():
    ...
    decision = input("Would you like to communicate with the ghost or run away? (communicate/run away): ")
    if decision.lower() == "communicate":
        communicate_with_ghost()
    elif decision.lower() == "run away":
...
def communicate_with_ghost():
    ...
    decision = input("Would you like to continue exploring or leave? (explore/leave): ")
...
def event3():
    ...
    decision = input("Would you like to keep running or enter the room? (run/enter): ")
...
def event4():
    ...
    decision = input("Would you like to investigate the room or keep moving forward? (investigate/keep moving): ")
    if decision.lower() == "investigate":
        print_with_delay("You step in the door and a giant axe comes flying towards you.", 0.05)
        print_with_delay("You die. Game Over!", 0.05)
        play_again()
    elif decision.lower() == "keep moving":
...
def search_riddle():
    ...
    decision = input("Would you like to search for clues in the riddle or keep moving forward? (search/keep moving): ")
    if decision.lower() == "search":
...
def another_decision():
    decision = input("Would you like to keep moving forward or give up? (keep moving/give up): ")
    if decision.lower() == "keep moving":
                print_with_delay("You decide to keep moving forward.", 0.05)
                print_with_delay("You see hundreds of bats flying towards you.", 0.05)
                print_with_delay("you make a run for it!", 0.05)
                event5()
    elif decision.lower() == "give up":
...
def event5():
    ...
    decision = input("There's a room close by. Would you like to keep running or get in the room? (keep running/get in the room): ")
    if decision.lower() == "keep running":
        ...
        play_again()
    elif decision.lower() == "get in the room":
...
def search_room():
    ...
    decision = input("Would you like to press the switch buttons or leave the room? (press buttons/leave): ")
    if decision.lower() == "press buttons":
...
def event6():
    ...
    decision = input("What will you do? Give up and hope help arrives or enter the code to the door? (give up/enter code): ")
    if decision.lower() == "give up":
        ...
        play_again()
    elif decision.lower() == "enter code":
...
def enter_code_to_vault():
    print_with_delay("The door screeches and slowly opens revealin a hidden passage!", 0.05)
    decision = input("Do you want to go inside down the hidden passage or go outside to keep going deeper into the mansion to find an alternate exit (inside the passage/try to find and alternate exit): ")
    if decision.lower() == "inside the passage":
        event7()
        
    elif decision.lower() == "try to find and alternate exit":
...
def event7():
    ...
    decision = input("Do you investigate the source of the sounds or go back? (investigate/go back): ")
    if decision.lower() == "investigate":
...
def event8():
    ...
    decision = input("Which door do you choose? Left, Right, or Straight? (left/right/straight): ")
    if decision.lower() == "left":
        ...
        decision = input("Do you investigate and try to pick the lock or continue exploring the library? (pick lock/continue exploring): ")
        if decision.lower() == "pick lock":
            ...
            print_with_delay("Game over!", 0.05)
            play_again()  
        elif decision.lower() == "continue exploring":
        ...
        decision = input("Do you eat the food or search for clues? (eat/search): ")
        if decision.lower() == "eat":
...
def event9():
    ...
    decision = input("Do you enter the passage or do not enter? (enter/do not enter): ")
    if decision.lower() == "enter":
        print_with_delay("You decide to enter the passage.", 0.05)
        event10()
    elif decision.lower() == "do not enter":
...
def event10():
    ...
    decision = input("Do you try to pick the lock or keep moving forward? (pick lock/keep going): ")
    if decision.lower() == "pick lock":
        ...
        print_with_delay("Game over!", 0.05)
        play_again()  
    elif decision.lower() == "keep going":
...
def event11():
    ...
    decision = input("Do you investigate the experiments to search for clues or search for an exit? (investigate/search exit): ")
    if decision.lower() == "investigate":
        ...
        event12()  
    elif decision.lower() == "search exit":
...
def event12():
    ...
    decision = input("Do you trust the map completely or trust your instincts? (trust map/trust instincts): ")
    if decision.lower() == "trust map":
        ...
        event13()
    elif decision.lower() == "trust instincts":
...
def event14():
    ...
    decision = input("Do you take only the key or examine the artifacts? (take key/examine artifacts): ")
    if decision.lower() == "take key":
        ...
        event15()
    elif decision.lower() == "examine artifacts":
